...
pub fn build(b: *std.Build) !void {
    ...
    const libxau_upstream = libxau.builder.dependency("libxau", .{});
    ...
    var xproto_c_sources = try std.ArrayList(Build.LazyPath).initCapacity(b.allocator, 0);
